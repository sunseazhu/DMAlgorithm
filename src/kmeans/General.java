...
public class General {
	 ...
	 * @param tongzhi 统智
	 * @param tongwuzhi 统武智  
	 * @param tongwuzhizheng 统武智政  
	 * @param salary 50级工资  
	 */
	public General(int render, String name, int tongshai, int wuli, int zhili, int polic, int qiangbin, int jibin, int nubin, int qibin, int binqi, int tongwu, int tongzhi, int tongwuzhi,
	 ...
	 * @param salary 50级工资  
	 */
	public General(int render, int tongshai, int wuli, int zhili, int polic, int qiangbin, int jibin, int nubin, int qibin, int binqi, int tongwu, int tongzhi, int tongwuzhi, int tongwuzhizheng,
			int salary) {
		super();
		this.name = "聚类中心";
		this.render = render;
	...
	public String toString() {
		return "武将 [name=" + name + ", render=" + Tool.dxingji(render) + ", tongshai=" + tongshai + ", wuli=" + wuli + ", zhili=" + zhili + ", polic=" + polic + ", qiangbin=" + Tool.dchange(qiangbin)
				+ ", jibin=" + Tool.dchange(jibin) + ", nubin=" + Tool.dchange(nubin) + ", qibin=" + Tool.dchange(qibin) + ", binqi=" + Tool.dchange(binqi) + ", tongwu=" + tongwu + ", tongzhi="
				+ tongzhi + ", tongwuzhi=" + tongwuzhi + ", tongwuzhizheng=" + tongwuzhizheng + ", salary=" + salary + "]";
	}
